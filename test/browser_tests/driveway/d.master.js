...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'master').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('master-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('master-add-btn').click();
            rider.findAllBySelector('ul#master_list li')
                .then(function (li) {
...
exports.updateModel = function (rider, values, callback) {
    rider
        .findById('master-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider
                .findById('master_list')
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('master-list-form')
        ...
        .then(function () {
            return rider.findById('master_list')
                .then(function (ul) {
                    var result = [];
