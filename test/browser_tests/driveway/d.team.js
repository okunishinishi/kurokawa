...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'team').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('team-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('team-add-btn').click();
            rider.findAllBySelector('ul#team_list li')
                .then(function (li) {
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('team-list-form')
        ...
        .then(function () {
            return rider.findById('team_list')
                .then(function (ul) {
                    var result = [];
