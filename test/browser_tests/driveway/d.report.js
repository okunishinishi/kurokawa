...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'report').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('report-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('report-add-btn').click();
            rider.findAllBySelector('ul#report_list li')
                .then(function (li) {
...
exports.updateModel = function (rider, values, callback) {
    rider
        .findById('report-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider
                .findById('report_list')
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('report-list-form')
        ...
        .then(function () {
            return rider.findById('report_list')
                .then(function (ul) {
                    var result = [];
