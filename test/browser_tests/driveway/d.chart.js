...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'chart').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('chart-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('chart-add-btn').click();
            rider.findAllBySelector('ul#chart_list li')
                .then(function (li) {
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('chart-list-form')
        ...
        .then(function () {
            return rider.findById('chart_list')
                .then(function (ul) {
                    var result = [];
