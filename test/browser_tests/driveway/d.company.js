...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'company').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('company-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('company-add-btn').click();
            rider.findAllBySelector('ul#company_list li')
                .then(function (li) {
...
exports.updateModel = function (rider, values, callback) {
    rider
        .findById('company-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider
                .findById('company_list')
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('company-list-form')
        ...
        .then(function () {
            return rider.findById('company_list')
                .then(function (ul) {
                    var result = [];
