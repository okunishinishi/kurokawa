...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'person_update').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('person_update-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('person_update-add-btn').click();
            rider.findAllBySelector('ul#person_update_list li')
                .then(function (li) {
...
exports.updateModel = function (rider, values, callback) {
    rider
        .findById('person_update-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider
                .findById('person_update_list')
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('person_update-list-form')
        ...
        .then(function () {
            return rider.findById('person_update_list')
                .then(function (ul) {
                    var result = [];
