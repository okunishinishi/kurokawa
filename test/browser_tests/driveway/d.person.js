...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'person').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('person-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('person-add-btn').click();
            rider.findAllBySelector('ul#person_list li')
                .then(function (li) {
...
exports.updateModel = function (rider, values, callback) {
    rider
        .findById('person-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider
                .findById('person_list')
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('person-list-form')
        ...
        .then(function () {
            return rider.findById('person_list')
                .then(function (ul) {
                    var result = [];
