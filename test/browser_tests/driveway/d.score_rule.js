...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'score_rule').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('score_rule-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('score_rule-add-btn').click();
            rider.findAllBySelector('ul#score_rule_list li')
                .then(function (li) {
...
exports.updateModel = function (rider, values, callback) {
    rider
        .findById('score_rule-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider
                .findById('score_rule_list')
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('score_rule-list-form')
        ...
        .then(function () {
            return rider.findById('score_rule_list')
                .then(function (ul) {
                    var result = [];
